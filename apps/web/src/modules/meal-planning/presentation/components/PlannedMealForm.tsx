  ...
  return (
    <form className="meal-planning-form" onSubmit={form.handleSubmit(onSubmit)}>
      <div className="form-field">
        ...
        <select id="planned-date" {...form.register('date')}>
          {dates.map((date) => (
      ...
      <div className="form-field">
        <label htmlFor="planned-source">Fuente</label>
      ...
      {source === 'PREVIOUS_MEAL' ? (
        <div className="form-field">
          ...
          <select id="previous-meal" {...form.register('previousMealId')}>
      ...
      <div className="form-field">
        <label htmlFor="meal-position">Posición</label>
        <input
          id="meal-position"
          type="number"
          min="0"

...
export interface PlannedMeal {
  ...
  date: string;
  type: MealType | 'EXTRA';
  source: MealSource | 'UNPLANNED' | 'EMPTY';
...
export interface InventoryComparisonItem extends WeeklyRequirement {
  available: number;
  missing: number;
  coverage: number;
...
export interface AdherenceSummary {
  ...
  percentages: { consumed: number; unplanned: number };
  nutrition: {

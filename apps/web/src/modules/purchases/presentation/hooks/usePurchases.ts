...
export const purchaseQueryKeys = {
  ...
  detail: (purchaseId: string) =>
    [...purchaseQueryKeys.all, 'detail', purchaseId] as const,
  list: (householdId: string, filters: PurchaseFilters = {}) =>
    [...purchaseQueryKeys.all, 'list', householdId, filters] as const,
};
...
export function usePurchases(
  ...
  return useQuery({
    ...
    queryKey: householdId
      ? purchaseQueryKeys.list(householdId, filters)
...
export function usePurchase(purchaseId: string | undefined) {
  return useQuery({
    ...
    queryKey: purchaseId
      ? purchaseQueryKeys.detail(purchaseId)
      : purchaseQueryKeys.all,
...
function usePurchaseMutation<TInput, TResult>(
...
export function useCreatePurchase() {
  return usePurchaseMutation(
    ({ householdId, input }: { householdId: string; input: PurchaseInput }) =>
      createPurchaseUseCase.execute(householdId, input),
  );
}
...
export function useUpdatePurchase() {
  return usePurchaseMutation(
    ...
    }) => updatePurchaseUseCase.execute(purchaseId, input),
  );
}

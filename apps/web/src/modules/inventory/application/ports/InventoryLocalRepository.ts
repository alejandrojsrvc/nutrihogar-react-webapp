...
export interface InventoryLocalRepository {
  ...
  saveOperationSnapshots?(snapshotsById: Record<string, InventoryItem>): Promise<void>;
  ...
  markOperationsConflicted?(operationIds: string[], detailsById: Record<string, { reason: string | null; conflictCode: string | null; retryable: boolean; resultingVersion: number | null; snapshot?: InventoryItem | null }>): Promise<void>;

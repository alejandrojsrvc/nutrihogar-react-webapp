    ...
    try {
      const item = await create.mutateAsync({
        ...
        input: {
          ...
          minimumQuantity: values.minimumQuantity.trim()
      ...
      if (!item) return;
      navigate(`/app/inventario/${item.id}`, {
        replace: true,
      ...
      >
        <fieldset>
          ...
          <div className="form-field">
            ...
            {selectedFood ? (
              <p className="inventory-selected-food">
        ...
        <fieldset>
          ...
          <div className="inventory-form-grid">
            ...
            <Field
              ...
              id="inventory-create-unit"
              label="Unidad *"
            >
              <select id="inventory-create-unit" {...register('unit')}>
